...
def train(hyperparams=None, data_path='gnn_embedding/data/emb', plot=True):
    ...
    # Radar plot
    radar_path = os.path.join(output_dir, f"{args.model_type}_{args.net_type}_epo{args.num_epochs}_gcl_embedding_quality_radar.png")
    ...
    dashboard_path = os.path.join(output_dir, f"{args.model_type}_{args.net_type}_epo{args.num_epochs}_gcl_embedding_quality_dashboard.png")
...
def visualize_gcl_comparison(emb_before, emb_after, cluster_labels, save_dir):
    ...
    tsne_path = os.path.join(output_dir, f"{args.model_type}_{args.net_type}_epo{args.num_epochs}_gcl_tsne_before_vs_after.png")
    plt.savefig(tsne_path, dpi=300)
    plt.show()
    ...
    plt.tight_layout()
    cos_path = os.path.join(output_dir, f"{args.model_type}_{args.net_type}_epo{args.num_epochs}_gcl_cosine_before_vs_after.png")
