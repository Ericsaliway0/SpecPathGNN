...
def train_and_evaluate(args, G_dgl, node_features):
    ...
    # ==========================================================
    # 4. Inner join: survival × cluster scores
    # ==========================================================
    ...
    # ==========================================================
    # 5. Final integrity checks (IMPORTANT)
    # ==========================================================
    ...
    # ==========================================================
    # 1. Inputs (assumed to exist)
    # ==========================================================
    # df_surv index          -> patient IDs
    # df_surv["time"]        -> survival time
    # df_surv["event"]       -> event indicator (1=event, 0=censored)
    # df_surv["Cluster_X"]   -> patient cluster scores
    ...
    # df_surv = pd.read_csv("../ACGNN/data/TCGA-BRCA.survival.tsv", sep="\t")
    # plot_global_km(df_surv, output_path)
    plot_global_km(
        df_surv,
        output_path=output_path,
        time_col="time",
