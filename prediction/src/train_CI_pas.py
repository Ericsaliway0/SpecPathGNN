...
def train_and_evaluate(args, G_dgl, node_features):
    ...
    # Required columns:
    # df_surv["time"]  -> survival time
    # df_surv["event"] -> event indicator (1=event, 0=censored)
    ...
    for col in patient_cluster_scores.columns:
        ...
        print(f"C-index (IPCW) {col}: {cindex_ipcw:.3f}")
        ...
        print(f"C-index (Harrell) {col}: {cindex_harrell:.3f}")
        ...
        print(f"Mean time-dependent AUC ({col}): {mean_auc:.3f}")
